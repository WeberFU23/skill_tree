...
MEMORY_CACHE_SUFFIX="${MEMORY_CACHE_SUFFIX:-locomo_skilltree_curated_agg055_top1_chars1200_cat3match_eval}" \
OUT_FILE="${OUT_FILE:-./results/locomo_skilltree_curated_agg055_top1_chars1200_cat3match_eval.json}" \
WANDB_RUN_NAME="${WANDB_RUN_NAME:-locomo-skilltree-curated-agg055-top1-chars1200-cat3match-eval}" \
