...
MEMORY_CACHE_SUFFIX="${MEMORY_CACHE_SUFFIX:-locomo_skilltree_curated_agg055_eval}" \
OUT_FILE="${OUT_FILE:-./results/locomo_skilltree_curated_agg055_eval.json}" \
WANDB_RUN_NAME="${WANDB_RUN_NAME:-locomo-skilltree-curated-agg055-eval}" \
