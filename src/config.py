...
def get_agentic_memory_args():
    ...
    parser.add_argument('--question-router-mode', type=str, default='risk_profile_baseline_v2',
                        choices=['risk_baseline_v1', 'risk_profile_baseline_v1', 'risk_profile_baseline_v2', 'risk_profile_baseline_v3', 'risk_profile_baseline_v4', 'candidate_all', 'baseline_all'],
